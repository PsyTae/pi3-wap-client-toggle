...
var Network = function Network() {
  return new Promise(function (resolve, reject) {
    ...
    var addKeyPair = function addKeyPair(elem) {
      return new Promise(function (addResolve, addReject) {
        try {
          ...
          return addResolve(!obj.actingAsHotSpot);
        } catch (err) {
          return addReject(err);
        }
      });
    };

    var toggleAP = function toggleAP(state) {
      return new Promise(function (apResolve, apRreject) {
    ...
    var initNetwork = function initNetwork(startAsHotspot, setupObj) {
      return new Promise(function (initResolve, initReject) {
        ...
        Promise.all(objKeys.map(addKeyPair)).then(
