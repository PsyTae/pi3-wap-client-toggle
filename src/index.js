...
const Network = () =>
  new Promise((resolve, reject) => {
    ...
    const toggleAP = state =>
      new Promise((apResolve, apRreject) => {
    ...
    const initNetwork = (startAsHotspot, setupObj) =>
      new Promise((initResolve, initReject) => {
        ...
        obj.eth0.server.dhcpLease =
          setupObj && setupObj.eth0 && setupObj.eth0.server && setupObj.eth0.server.dhcpLease ? setupObj.eth0.server.dhcpLease : "12h";
